...
###### ref-3-2
**\[3.2\]** 2604.06256 — Xu, "Spectral Edge Dynamics Reveal Functional Modes of Learning". Nuance: what is declared to be the support is not the value of $R^{2}$ (for $x^{2}+y^{2}$ it is $0.15\text{–}0.16$) but the qualitative selectivity of the cross terms; there are no causal interventions. [`"We test this by probing the perturbation with three feature sets via ridge regression"`](../papers/2604.06256.spectral-edge-dynamics-reveal-functional-modes-of-learning/original/2604.06256.spectral-edge-dynamics-reveal-functional-modes-of-learning.md#p11-6).
