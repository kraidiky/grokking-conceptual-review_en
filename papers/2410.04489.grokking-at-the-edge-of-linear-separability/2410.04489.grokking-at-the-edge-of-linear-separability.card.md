...
**[The optimiser](../../concepts/optimizer-adam-adamw-sgd.md)** — an honest and useful caveat: under ordinary gradient descent the accuracy rises from the very beginning, and a "plateau at the chance level", as in Power et al., is obtained by switching to Adam ([`p2-3`](#p2-3), [`fig-5`](#fig-5)). An adaptive learning rate drives $\|\boldsymbol{S}\|$ onto the "memorising" solution faster and holds the accuracy down longer. The authors call this outright a superficial difference and work with GD for the sake of analytical tractability.
