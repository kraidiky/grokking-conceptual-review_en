...
**[Modular arithmetic](../../concepts/modular-arithmetic.md)** and **[non-abelian groups](../../concepts/group-composition-non-commutative-s5.md)** — the settings: addition, multiplication and subtraction modulo 97 and the composition of permutations in $S_{5}$ (120 classes, $94\%$ of the pairs non-commuting). The indicator is present in both, but the threshold is task-specific: $0.589$–$0.605$ against $0.655$ ([`p10-2`](#p10-2), [`p10-3`](#p10-3), [`p10-4`](#p10-4)).
