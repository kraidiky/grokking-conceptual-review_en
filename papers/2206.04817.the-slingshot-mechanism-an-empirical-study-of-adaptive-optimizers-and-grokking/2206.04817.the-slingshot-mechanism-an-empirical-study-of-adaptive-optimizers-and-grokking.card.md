...
**[The emergence of features / feature learning](../../concepts/feature-emergence-feature-learning.md)** — the work gives a **measurable anchoring of the moment of feature learning**: the relative change of the features $\frac{\Vert h^{l}_ {t+1}-h^{l}_ {t}\Vert}{\Vert h^{l}_ {t}\Vert}$ shows that the feature maps are updated in a jump at the phase transition. In appendix B this is supported by the cosine distance from the initialisation: in runs with a slingshot the representation parameters travel further.
